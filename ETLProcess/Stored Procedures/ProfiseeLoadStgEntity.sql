...
CREATE PROCEDURE [ETLProcess].[ProfiseeLoadStgEntity]
                                           ...
                                           BEGIN TRY
                                                          ...
                                                          BEGIN
                                                                        ...
                                                                        WHERE 
                                                                                      ...
                                                                                      AND COLUMN_NAME NOT IN('IsValid','ID','Data_Source_ID','DateCreatedUTC','LastModifiedDateUTC','Code','IsDuplicate')
                                                                        ORDER BY 
                                                                                      COLUMN_NAME;
                                                          ...
                                                          BEGIN
                                                                        ...
                                                                        IF @TableName='Address'
                                                                                      BEGIN
                                                                                                     ...
                                                                                                     WHERE 
                                                                                                                   TABLE_SCHEMA='dbo' 
                                                                                                                   AND TABLE_NAME=@TableName
                                                                                                                   AND COLUMN_NAME NOT IN('IsValid','ID','Data_Source_ID','IsMADReceived','IsMADSent','MADReceivedDateUTC','MADSentDateUTC','IsDuplicate')
                                                                                                     ORDER BY 
                                                                                                                   COLUMN_NAME;
                                                                                                     ...
                                                                                                     SET @SelectClause= LEFT(@SelectClause,LEN(@SelectClause)-1)+N' FROM dbo.'+@TableName+N' WHERE ISNUMERIC(MasterAddressID)=0 AND IsDuplicate=0';
                                                                                                     ...
                                                                                                     ,             Range
                                                                                                     ,             Region
																									 ,				RegionalHospitalDistrict_DistrictDescription
																									 ,				SchoolDistrict
                                                                                                     ...
                                                                                                     FROM 
																												   ...
																												   AND MADAddress.SourceAddressID = [Address].Code
                                                                                                     WHERE
                                                                                                                   ISNUMERIC([Address].MasterAddressID)=1 AND [Address].IsDuplicate=0';
                                                                        ...
                                                                        IF @TableName IN('Taxation', 'PIN',	'Permit')
                                                                                      BEGIN
                                                                                                     SELECT  
                                                                                                                   @InsertClause = @InsertClause+COLUMN_NAME+N','
                                                                                                     FROM 
                                                                                                     ...
                                                                                                     WHERE 
                                                                                                                   TABLE_SCHEMA='dbo' 
                                                                                                                   AND TABLE_NAME=@TableName
                                                                                                                   AND COLUMN_NAME NOT IN('IsValid','ID','Data_Source_ID','IsDuplicate')
                                                                                                     ORDER BY 
                                                                                                                   COLUMN_NAME;
                                                                                                     ...
                                                                                                     SET @SelectClause= @SelectClause+' '+
                                                                                                                                 CASE 
																																				...
																																				WHEN @TableName = 'Permit'  THEN N' ISNULL(MasterAddressID,'''')+'':''+ ISNULL(ARN,'''')+'':''+ ISNULL(JurCode,'''')'  
                                                                                                                                 END +N' AS MatchKeyMember' 

                                                                                                     SET @SelectClause= @SelectClause+N' FROM dbo.'+@TableName +' WHERE IsDuplicate=0'; 
                                                                        ...
                                                                        IF @TableName IN('Business', 'Sales')
                                                                                      BEGIN
                                                                                                     ...
                                                                                                     WHERE 
                                                                                                                   TABLE_SCHEMA='dbo' 
                                                                                                                   AND TABLE_NAME=@TableName
                                                                                                                   AND COLUMN_NAME NOT IN('IsValid','ID','Data_Source_ID','MasterAddressID','IsDuplicate')
                                                                                                     ORDER BY 
                                                                                                                   COLUMN_NAME;
                                                                                                     ...
                                                                                                     SET @SelectClause =@SelectClause+N' Address.MasterAddressID FROM dbo.'+@TableName+N' Main LEFT JOIN dbo.Address Address ON Address.Code = Main.Code WHERE Main.IsDuplicate=0 '

                                                                                                     IF @LastRetrievedDateTime<>'1900-01-01'
                                                                                                                   SET @SelectClause= @SelectClause
                                                                                                                                                +N' AND ( Main.LastModifiedDateUTC > CAST('''+CAST(@LastRetrievedDateTime AS NVARCHAR(30))+N''' AS DATETIME) OR'
                                                                        ...
                                                                        IF @TableName IN('Valuation', 'Listing')
                                                                                      BEGIN
                                                                                                     ...
                                                                                                     WHERE 
                                                                                                                   TABLE_SCHEMA='dbo' 
                                                                                                                   AND TABLE_NAME=@TableName
                                                                                                                   AND COLUMN_NAME NOT IN('IsValid','ID','Data_Source_ID','MasterAddressID','PIN','ARN','IsDuplicate')
                                                                                                     ORDER BY 
                                                                                                                   COLUMN_NAME;
                                                                                                     ...
                                                                                                     SET @SelectClause =@SelectClause+N' Address.MasterAddressID, PIN.PIN, Taxation.ARN FROM dbo.'+@TableName+N' Main LEFT JOIN dbo.Address Address ON Address.Code = Main.Code LEFT JOIN dbo.PIN PIN ON PIN.Code = Main.Code'
                                                                                                                   +N' LEFT JOIN dbo.Taxation Taxation ON Taxation.Code = Main.Code WHERE Main.IsDuplicate=0 '
                                                                        ...
                                                                        IF @TableName IN('Building', 'Parcel')
                                                                                      BEGIN
                                                                                                     ...
                                                                                                     WHERE 
                                                                                                                   TABLE_SCHEMA='dbo' 
                                                                                                                   AND TABLE_NAME=@TableName
                                                                                                                   AND COLUMN_NAME NOT IN('IsValid','ID','Data_Source_ID','MasterAddressID','PIN','IsDuplicate')
                                                                                                     ORDER BY 
                                                                                                                   COLUMN_NAME;
                                                                                                    ...
                                                                                                    SET @SelectClause =@SelectClause+N' Address.MasterAddressID, PIN.PIN FROM dbo.'+@TableName+N' Main LEFT JOIN dbo.Address Address ON Address.Code = Main.Code LEFT JOIN dbo.PIN PIN ON PIN.Code = Main.Code WHERE Main.IsDuplicate=0 '
