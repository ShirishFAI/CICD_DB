...
CREATE PROCEDURE [ETLProcess].[BC_AddFolio_Through_Weekly]
AS
BEGIN
/****************************************************************************************
-- AUTHOR		: Shirish W.
...
--**************************************************************************************************************************
	...
	DROP TABLE IF EXISTS #UPTD_PrimaryAddress;
	DROP TABLE IF EXISTS #UPTD_ChangedToPrimary;
	DROP TABLE IF EXISTS #UPTD_Sales;
	DROP TABLE IF EXISTS #UPTD_Legal;
...
--**********************************************************************************************************
	...
	SELECT DISTINCT WK.FolioRecord_ID
		,WK.RollYear
		,WK.AssessmentAreaDescription
		,WK.JurisdictionCode
		,WK.JurisdictionDescription
		,WK.RollNumber
		,WK.ActualUseDescription
		,WK.VacantFlag
		,WK.TenureDescription
		,WK.FolioAddresses_FolioAddress_City
		,WK.FolioAddresses_FolioAddress_ID
		,WK.FolioAddresses_FolioAddress_PostalZip
		,WK.FolioAddresses_FolioAddress_PrimaryFlag
		...
		,WK.FolioAddresses_FolioAddress_StreetType
		,WK.FolioAddresses_FolioAddress_UnitNumber
		,WK.LandMeasurement_LandDepth
		,WK.LandMeasurement_LandDimension
		,WK.LandMeasurement_LandDimensionTypeDescription
		,WK.LandMeasurement_LandWidth
		,WK.FolioDescription_Neighbourhood_NeighbourhoodCode
		,WK.FolioDescription_Neighbourhood_NeighbourhoodDescription
		,WK.RegionalDistrict_DistrictDescription
		,WK.SchoolDistrict_DistrictDescription
		,NULL AS LegalDescriptions_LegalDescription_Block
		,NULL AS LegalDescriptions_LegalDescription_DistrictLot
		,NULL AS LegalDescriptions_LegalDescription_ExceptPlan
		,NULL AS LegalDescriptions_LegalDescription_FormattedLegalDescription
		,NULL AS LegalDescriptions_LegalDescription_ID
		,NULL AS LegalDescriptions_LegalDescription_LandDistrict
		,NULL AS LegalDescriptions_LegalDescription_LandDistrictDescription
		,NULL AS LegalDescriptions_LegalDescription_LeaseLicenceNumber
		,NULL AS LegalDescriptions_LegalDescription_LegalText
		,NULL AS LegalDescriptions_LegalDescription_Lot
		,NULL AS LegalDescriptions_LegalDescription_Meridian
		,NULL AS LegalDescriptions_LegalDescription_MeridianShort
		,NULL AS LegalDescriptions_LegalDescription_Parcel
		,NULL AS LegalDescriptions_LegalDescription_Part1
		,NULL AS LegalDescriptions_LegalDescription_Part2
		,NULL AS LegalDescriptions_LegalDescription_Part3
		,NULL AS LegalDescriptions_LegalDescription_Part4
		,NULL AS LegalDescriptions_LegalDescription_PID
		,NULL AS LegalDescriptions_LegalDescription_Plan
		,NULL AS LegalDescriptions_LegalDescription_Portion
		,NULL AS LegalDescriptions_LegalDescription_Range
		,NULL AS LegalDescriptions_LegalDescription_Section
		,NULL AS LegalDescriptions_LegalDescription_StrataLot
		,NULL AS LegalDescriptions_LegalDescription_SubBlock
		,NULL AS LegalDescriptions_LegalDescription_SubLot
		,NULL AS LegalDescriptions_LegalDescription_LegalSubdivision
		,NULL AS LegalDescriptions_LegalDescription_Township
		,NULL AS Sales_Sale_ConveyanceDate
		,NULL AS Sales_Sale_ConveyancePrice
		,NULL AS Sales_Sale_ID
		,HASHBYTES('SHA2_512', CONCAT_WS('|', WK.FolioRecord_ID,WK.RollYear,WK.AssessmentAreaDescription,WK.JurisdictionCode,WK.JurisdictionDescription,WK.RollNumber,WK.ActualUseDescription,WK.VacantFlag,WK.TenureDescription,WK.FolioAddresses_FolioAddress_City,WK.FolioAddresses_FolioAddress_ID,WK.FolioAddresses_FolioAddress_PostalZip,WK.FolioAddresses_FolioAddress_PrimaryFlag,WK.FolioAddresses_FolioAddress_ProvinceState,WK.FolioAddresses_FolioAddress_StreetDirectionSuffix,WK.FolioAddresses_FolioAddress_StreetName,WK.FolioAddresses_FolioAddress_StreetNumber,WK.FolioAddresses_FolioAddress_StreetType,WK.FolioAddresses_FolioAddress_UnitNumber,WK.LandMeasurement_LandDepth,WK.LandMeasurement_LandDimension,WK.LandMeasurement_LandDimensionTypeDescription,WK.LandMeasurement_LandWidth,WK.FolioDescription_Neighbourhood_NeighbourhoodCode,WK.FolioDescription_Neighbourhood_NeighbourhoodDescription,WK.RegionalDistrict_DistrictDescription,WK.SchoolDistrict_DistrictDescription,WK.LegalDescriptions_LegalDescription_Block,WK.LegalDescriptions_LegalDescription_DistrictLot,WK.LegalDescriptions_LegalDescription_ExceptPlan,WK.LegalDescriptions_LegalDescription_FormattedLegalDescription,WK.LegalDescriptions_LegalDescription_ID,WK.LegalDescriptions_LegalDescription_LandDistrict,WK.LegalDescriptions_LegalDescription_LandDistrictDescription,WK.LegalDescriptions_LegalDescription_LeaseLicenceNumber,WK.LegalDescriptions_LegalDescription_LegalText,WK.LegalDescriptions_LegalDescription_Lot,WK.LegalDescriptions_LegalDescription_Meridian,WK.LegalDescriptions_LegalDescription_MeridianShort,WK.LegalDescriptions_LegalDescription_Parcel,WK.LegalDescriptions_LegalDescription_Part1,WK.LegalDescriptions_LegalDescription_Part2,WK.LegalDescriptions_LegalDescription_Part3,WK.LegalDescriptions_LegalDescription_Part4,WK.LegalDescriptions_LegalDescription_PID,WK.LegalDescriptions_LegalDescription_Plan,WK.LegalDescriptions_LegalDescription_Portion,WK.LegalDescriptions_LegalDescription_Range,WK.LegalDescriptions_LegalDescription_Section,WK.LegalDescriptions_LegalDescription_StrataLot,WK.LegalDescriptions_LegalDescription_SubBlock,WK.LegalDescriptions_LegalDescription_SubLot,WK.LegalDescriptions_LegalDescription_LegalSubdivision,WK.LegalDescriptions_LegalDescription_Township,WK.Sales_Sale_ConveyanceDate,WK.Sales_Sale_ConveyancePrice,WK.Sales_Sale_ID)) AS HashBytes
...
--Step 3. Address with updated primary flag
	...
	-- Get Property Data from UpToDate
	--SELECT *
	--INTO #UPTD_ChangedToPrimary
	--FROM (
	--SELECT UPTD.*
	--	,ROW_NUMBER() OVER (PARTITION BY UPTD.Foliorecord_ID,AdPr.FolioAddresses_FolioAddress_ID ORDER BY UPTD.Foliorecord_ID,AdPr.FolioAddresses_FolioAddress_ID,UPTD.RollYear DESC) AS RowNum
	--FROM dbo.BC_UPTO_DATE UPTD
	--INNER JOIN #Address_ChangedToPrimary AdPr ON UPTD.FolioRecord_ID = AdPr.FolioRecord_ID
	--AND UPTD.FolioAddresses_FolioAddress_ID = AdPr.FolioAddresses_FolioAddress_ID
	--) UPTD
	--WHERE RowNum = 1;
	...
	SELECT DISTINCT UPTD.FolioRecord_ID,UPTD.AssessmentAreaDescription,UPTD.JurisdictionCode,UPTD.JurisdictionDescription,UPTD.RollNumber,UPTD.ActualUseDescription,UPTD.VacantFlag,UPTD.TenureDescription,UPTD.LandMeasurement_LandDepth,UPTD.LandMeasurement_LandDimension,UPTD.LandMeasurement_LandDimensionTypeDescription,UPTD.LandMeasurement_LandWidth,UPTD.FolioDescription_Neighbourhood_NeighbourhoodCode,UPTD.FolioDescription_Neighbourhood_NeighbourhoodDescription,UPTD.RegionalDistrict_DistrictDescription,UPTD.SchoolDistrict_DistrictDescription,UPTD.LegalDescriptions_LegalDescription_Block,UPTD.LegalDescriptions_LegalDescription_DistrictLot,UPTD.LegalDescriptions_LegalDescription_ExceptPlan,UPTD.LegalDescriptions_LegalDescription_FormattedLegalDescription,UPTD.LegalDescriptions_LegalDescription_ID,UPTD.LegalDescriptions_LegalDescription_LandDistrict,UPTD.LegalDescriptions_LegalDescription_LandDistrictDescription,UPTD.LegalDescriptions_LegalDescription_LeaseLicenceNumber,UPTD.LegalDescriptions_LegalDescription_LegalText,UPTD.LegalDescriptions_LegalDescription_Lot,UPTD.LegalDescriptions_LegalDescription_Meridian,UPTD.LegalDescriptions_LegalDescription_MeridianShort,UPTD.LegalDescriptions_LegalDescription_Parcel,UPTD.LegalDescriptions_LegalDescription_Part1,UPTD.LegalDescriptions_LegalDescription_Part2,UPTD.LegalDescriptions_LegalDescription_Part3,UPTD.LegalDescriptions_LegalDescription_Part4,UPTD.LegalDescriptions_LegalDescription_PID,UPTD.LegalDescriptions_LegalDescription_Plan,UPTD.LegalDescriptions_LegalDescription_Portion,UPTD.LegalDescriptions_LegalDescription_Range,UPTD.LegalDescriptions_LegalDescription_Section,UPTD.LegalDescriptions_LegalDescription_StrataLot,UPTD.LegalDescriptions_LegalDescription_SubBlock,UPTD.LegalDescriptions_LegalDescription_SubLot,UPTD.LegalDescriptions_LegalDescription_LegalSubdivision,UPTD.LegalDescriptions_LegalDescription_Township,UPTD.Sales_Sale_ConveyanceDate,UPTD.Sales_Sale_ConveyancePrice,UPTD.Sales_Sale_ID
	FROM dbo.BC_UPTO_DATE UPTD
	INNER JOIN #Address_ChangedToPrimary NP ON UPTD.FolioRecord_ID = NP.FolioRecord_ID
	) UPTD;
	...
	FROM #UPTD_ChangedToPrimary UPTD
...
-- Step 4. Add New Sales data
	...
	FROM (
	SELECT UPTD.*
		,ROW_NUMBER() OVER (PARTITION BY UPTD.Foliorecord_ID ORDER BY UPTD.Foliorecord_ID,UPTD.RollYear DESC) AS RowNum
	FROM dbo.BC_UPTO_DATE UPTD
	INNER JOIN #Sales_Weekly Sales on UPTD.FolioRecord_ID = Sales.FolioRecord_ID 
	WHERE UPTD.FolioAddresses_FolioAddress_PrimaryFlag = 'True'
	) UPTD
	WHERE RowNum = 1;
...
--************************************************************************************************************************
	...
	SELECT UPTD.*
		,ROW_NUMBER() OVER (PARTITION BY UPTD.Foliorecord_ID ORDER BY UPTD.Foliorecord_ID,UPTD.RollYear DESC) AS RowNum
	FROM dbo.BC_UPTO_DATE UPTD
	INNER JOIN #NewLegal Legal ON UPTD.FolioRecord_ID = Legal.FolioRecord_ID
	WHERE UPTD.FolioAddresses_FolioAddress_PrimaryFlag = 'True'
	) UPTD
	WHERE RowNum = 1;
	...
	INTO #NewLegal_Final
	FROM #UPTD_Legal UPTD
	INNER JOIN #NewLegal WK ON UPTD.FolioRecord_ID = WK.FolioRecord_ID 
	AND UPTD.FolioAddresses_FolioAddress_PrimaryFlag = 'True';
...
--*************************************************************************************************************
	...
	-- Step 7. Insert previous invalid records that turned valid now
	/*
	INSERT INTO StageLanding.BC_ALL_Assessment (
		FolioRecord_ID
		,RollYear
...
Select DISTINCT UPTD.FolioRecord_ID
	...
	AND WK.RollNumber=UPTD.RollNumber AND WK.JurisdictionCode=UPTD.JurisdictionCode 
	AND WK.FolioAddresses_FolioAddress_PrimaryFlag = UPTD.FolioAddresses_FolioAddress_PrimaryFlag
	WHERE 
		(
			(
				...
				AND ISNULL(UPTD.FolioAddresses_FolioAddress_StreetName,'') = ''
			)
			AND
			(
				...
				AND ISNULL(UPTD.FolioAddresses_FolioAddress_StreetNumber,'') = ''
			)
		)
	...
	FROM StageLanding.BC_ALL_Assessment_Weekly WK
	INNER JOIN dbo.BC_UPTO_DATE UPTD ON WK.FolioRecord_ID = UPTD.FolioRecord_ID 
		AND WK.LegalDescriptions_LegalDescription_ID = UPTD.LegalDescriptions_LegalDescription_ID 
		AND Wk.FolioAddresses_FolioAddress_PrimaryFlag = UPTD.FolioAddresses_FolioAddress_PrimaryFlag
