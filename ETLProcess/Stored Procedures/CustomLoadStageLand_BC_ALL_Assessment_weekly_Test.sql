...
******************************************************************************************/  
CREATE PROCEDURE [ETLProcess].[CustomLoadStageLand_BC_ALL_Assessment_weekly_Test]
...
BEGIN
   ...
   --Select @DynamicSQL
	...
	SET @XML = (SELECT XMLData FROM StageLanding.BCAWeeklyXML_Test);
...
-- Insert All Records into Landing table
	...
	SELECT  distinct FR.FolioRecordID
		   , DataAdvice.RunType--@RunType
		   , DataAdvice.RollYear--@RollYear
		   , DataAdvice.OwnershipYear--@OwnershipYear
		   , DataAdvice.StartDate--@StartDate
		   , DataAdvice.EndDate--@EndDate
		   , DataAdvice.RunDate--@RunDate
