CREATE TABLE [dbo].[Parcel] (
    ...
    [IsDuplicate]                      INT             CONSTRAINT [DEFAULT_Parcel_IsDuplicate] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_Parcel_ID] PRIMARY KEY NONCLUSTERED ([ID] ASC) WITH (FILLFACTOR = 80)
);


GO
CREATE UNIQUE CLUSTERED INDEX [IX_Parcel_Code]
    ON [dbo].[Parcel]([Code] ASC) WITH (FILLFACTOR = 80);


GO
CREATE NONCLUSTERED INDEX [IX_Parcel_LastModifiedDateUTC]
    ON [dbo].[Parcel]([LastModifiedDateUTC] ASC) WITH (FILLFACTOR = 80);
