CREATE TABLE [dbo].[Building] (
    ...
    [IsDuplicate]            INT             CONSTRAINT [DEFAULT_Building_IsDuplicate] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_Building_ID] PRIMARY KEY NONCLUSTERED ([ID] ASC) WITH (FILLFACTOR = 80)
);


GO
CREATE UNIQUE CLUSTERED INDEX [IX_Building_Code]
    ON [dbo].[Building]([Code] ASC) WITH (FILLFACTOR = 80);


GO
CREATE NONCLUSTERED INDEX [IX_Building_LastModifiedDateUTC]
    ON [dbo].[Building]([LastModifiedDateUTC] ASC) WITH (FILLFACTOR = 80);


GO
CREATE NONCLUSTERED INDEX [IX_Building_ProvinceCode]
    ON [dbo].[Building]([ProvinceCode] ASC) WITH (FILLFACTOR = 80);
