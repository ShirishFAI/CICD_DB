...
GO
CREATE NONCLUSTERED INDEX [IX_BCUptoDate]
    ON [dbo].[BC_UPTO_DATE]([FolioRecord_ID] ASC, [FolioAddresses_FolioAddress_ID] ASC, [LegalDescriptions_LegalDescription_ID] ASC, [Sales_Sale_ID] ASC, [RollYear] ASC) WITH (FILLFACTOR = 80);
