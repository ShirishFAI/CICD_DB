CREATE TABLE [dbo].[Permit_Invalid] (
    ...
    [IsDuplicate]             INT           CONSTRAINT [DEFAULT_Permit_Invalid_IsDuplicate] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_Permit_Invalid_ID] PRIMARY KEY NONCLUSTERED ([ID] ASC) WITH (FILLFACTOR = 80)
);
