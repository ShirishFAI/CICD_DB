CREATE TABLE [SourceHistory].[BC_ALL_Assessment_11152022] (
...
CREATE CLUSTERED INDEX [CI_SourceHistory_BC_ALL_Assessment_Code]
    ON [SourceHistory].[BC_ALL_Assessment_11152022]([Code] ASC) WITH (FILLFACTOR = 80);


GO
CREATE NONCLUSTERED INDEX [NCI_SourceHistory_BC_ALL_Assessment_HistEndDate]
    ON [SourceHistory].[BC_ALL_Assessment_11152022]([HistEndDate] ASC) WITH (FILLFACTOR = 80);
